...
public class Rogue extends Character{
    ...
    //return string with info about class
    public String about(){
	String s;
	s = "Rogue: A scoundrel who will employ every trick to gain the upper hand.\n";
	s += "\tThe rogue has no honor and will strike where it hurts the most, the rogue can kill enemies with one strike and escape death.\n";
	return s;
    }
